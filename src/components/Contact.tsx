...
export default function Contact() {
    return (
        <section className="py-24 md:py-32 bg-[#0a0a0a] " id='contact'>
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    <a
                        ...
                        className="flex items-start space-x-4 p-6 bg-black hover:bg-zinc-900 rounded-lg transition-all group border-l-4 border-transparent hover:border-[#FFCC00]"
                    >
                        ...
                        <div>
                            ...
                            <p className="text-gray-400">narrativenepal@gmail.com</p>
                        </div>
                    </a>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-gray-400">+977 9843937267</p>
                        </div>
                    </a>

                    <div className="flex items-start space-x-4 p-6 bg-black rounded-lg border-l-4 border-[#FFCC00]">
                        <div className="w-12 h-12 bg-[#FFCC00] rounded-full flex items-center justify-center flex-shrink-0">
                            <MapPin className="w-6 h-6 text-black" />
                        </div>
                        <div>
                            <h3 className="font-bold text-lg mb-1">Location</h3>
                            <p className="text-gray-400">Sanothimi, Bhaktapur, Nepal</p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-gray-400">www.narrativenepal.com.np</p>
                        </div>
                    </a>
                </div>
