...
export default function FoundersNote() {
  return (
    <section className="py-24 md:py-32 bg-white text-gray-900  transition-colors duration-300">
        ...
        <div className="order-1 md:order-2">
          <div className="mb-6">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              From the <span className="text-[#FFCC00] text-stroke">Documentarian</span>
            </h2>
            <div className="w-20 h-1 bg-[#FFCC00]"></div>
          </div>

          {/* Quote */}
          <blockquote className="text-gray-600  text-lg leading-relaxed italic mb-6 border-l-4 border-[#FFCC00] pl-4">
          ...
          <p className="text-gray-800  text-lg font-medium mb-1">
            — <span className="text-gray-900  font-semibold">Suvash Chaulagain</span>
          </p>
          ...
          <div className="flex space-x-6">
            <a
              ...
              className="text-gray-600  hover:text-[#FFCC00] transition-colors duration-300"
            >
